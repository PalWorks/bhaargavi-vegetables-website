...
const DEFAULT_MENU_ITEMS: MenuItem[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1618512496248-a07f50c34f8e?w=400&q=80',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1615485500704-8e990f9900f5?w=400&q=80',
    category: 'cut',
    ingredients: ['Garlic'],
  },
  {
  ...
  },
  {
    ...
    packSizes: [{ weight: '250 g', price: 40 }, { weight: '500 g', price: 75 }, { weight: '1 kg', price: 140 }],
    image: 'https://images.unsplash.com/photo-1590868309235-ea34bed7bd7f?w=400&q=80',
    category: 'cut',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1550828488-bc8d677e5c9c?w=400&q=80',
    category: 'cut', isBestseller: true,
...
const DEFAULT_INSTAGRAM_POSTS: InstagramPost[] = [
  ...
  { id: '7', image: 'https://picsum.photos/seed/bv7/400/400', caption: 'Minimum order Rs 199. Delivery across Chennai. Order on WhatsApp! #Delivery', likes: 210, link: INSTAGRAM_URL, mediaType: 'image' },
